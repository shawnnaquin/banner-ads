...
var gulp = require('gulp'),
    ...
    build = '../../../../build/servpro-water-damage-300x250-build/',
    src = './src/';
...
gulp.task('watch', function () {
  ...
  gulp.watch([paths.scripts + 'app.js', paths.scripts + 'script.js'], ['scripts']); // Watch .js files
  gulp.watch(paths.scripts + 'EBLoader.js', ['EBLoader']); // Watch .js files
